...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#eef2f6] dark:bg-[#0a0a0c] transition-colors duration-300">
            ...
            <div className="flex items-center justify-between h-14">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 rounded-[10px] text-[13px] font-medium transition-all duration-200 liquid-glass-card text-slate-500 dark:text-[rgba(255,255,255,0.55)] hover:text-slate-900 dark:hover:text-white"
                >
                  <svg className="w-[15px] h-[15px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <ProviderSettings isOpen={showSettings} onClose={() => setShowSettings(false)} />
